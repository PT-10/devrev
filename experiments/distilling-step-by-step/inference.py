...
checkpoint_path = "ckpts/svamp/t5-v1_1-base/task_prefix/palm/1.0/llm/0.5/1024/8/AdamW/5e-05/0/checkpoint-10000"
...
input_text = f"Summarize all issues related to 'CUST123'. Give result as a json: {json_format}"
